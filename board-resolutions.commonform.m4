\\ Per Section 141(f) of the Delaware General Corporation Law and the Bylaws of [Company Name], a Delaware corporation (the ""Company""), the undersigned, constituting all the members of the <Company>'s Board of Directors (the ""Board""), take the following actions and adopt the following resolutions by unanimous written consent without a meeting:
    ...
    Election of Officers \\ The following people are elected as officers of the <Company> to the offices listed opposite their respective names, to serve at the pleasure of the <Board>: [List of Officers].

    Officers \\ The Chief Executive Officer is authorized to sign and deliver any agreement in the name of the <Company> and to otherwise obligate the <Company> in any respect relating to matters of the business of the <Company>, and to delegate such authority in his or her discretion, within budgets approved by the <Board>.

    Uncertificated Stock \\

        \\ The <Company> may issue certificated shares for some or all of any or all classes or series of its stock if deemed advisable and in the best interests of the <Company> by the officers, in consultation with legal counsel. Otherwise, the shares of the <Company> shall be uncertificated.

        \\ The officers are authorized and directed to send a written notice to record owners of shares of uncertificated stock per the Delaware General Corporation Law (on the request of such record owner) substantially in the form provided to the <Board>, with such changes deemed necessary or advisable by the officers, in consultation with legal counsel.

    Sale and Issuance of Stock \\

        \\ The officers are authorized to sell and issue on behalf of the <Company> the shares of stock as listed in {Initial Stock Issuance Table} (the ""Shares"") to the purchasers listed (each a ""Purchaser"") in the amounts and subject to the vesting provisions specified opposite the <Purchaser>'s name, at the price per share as listed in {Initial Stock Issuance Table}, which the <Board> determines to be the fair value of such <Shares> as of the date of these resolutions, and in exchange for the property listed in {Initial Stock Issuance Table}, which the <Board> determines to have a value equal to the fair value of the <Shares>.

        \\ Each stock sale authorized in the above resolution shall be made by a stock purchase agreement in substantially the form attached as {Form(s) Of Stock Purchase Agreement}.

        \\ On the <Company>'s receipt of a fully signed stock purchase agreement and the property provided for by the agreement, the <Company> is authorized and directed to issue the <Shares>.

        \\ It is desirable and in the best interest of the <Company> that its securities be qualified or registered for sale in various states; that the President or any Vice President and the Secretary or any Assistant Secretary are authorized to determine the states in which appropriate action shall be taken to qualify or register for sale all or such part of the securities of the <Company> as the officers think advisable; that the officers are authorized to do on behalf of the <Company> any such acts as they deem necessary or advisable to comply with the laws of any such states, and in connection with compliance to sign and file all necessary papers and documents, like applications, reports, surety bonds, irrevocable consents, and appointments of attorneys for service of process; and the signature by such officers of any such paper or document or the doing by them of any act in connection with such regulatory matters shall conclusively establish their authority from the <Company> and the approval and ratification by the <Company> of the papers and documents so signed and the action so taken.

        \\ The stock sales authorized in the above resolution shall be conducted to qualify for the exemption from state requirements regarding registration of the sale of securities.

        \\ The officers and their designees or agents are authorized and directed to:

            \\ sign and file a form of notification advising the [State Securities Law Authority] of the issuance of the <Shares> per [State Securities Law Reference] and
    ...
    Withholding Tax \\ Resolved: That the officers are authorized and directed to consult with the bookkeeper, auditors and attorneys of the <Company> to be fully informed about, and collect and pay promptly when due, all withholding tax for which the <Company> may now be (or later becomes) liable.

    Qualification to Do Business \\ Resolved: That the officers of the <Company> are authorized to take any steps that they deem to be necessary to qualify the <Company> to do business as a foreign corporation in each state that the officers determine such qualification to be necessary or appropriate.
...
\\
    ...
    Initial Stock Issuance Table \\ [List of stock purchasers with number of shares, exchanged property, and vesting terms for each.]
