This Indemnification Agreement (this ""Agreement"") between [Company Name], a Delaware corporation (the ""Company""), and [Indemnitee Name] (""Indemnitee"") is dated as of [Effective Date] (the ""Effective Date""). The parties agree as follows:
    ...
    \ Indemnification Procedure \
        ...
        \ Determination of Entitlement \
            ...
            \ No Early Decision \ This <Agreement> does not require any decision about whether <Indemnitee> is entitled to indemnification for a <Legal Dispute> under this <Agreement> before <Final Court Decision> of the <Legal Dispute>.
    ...
    \ Additional Indemnification Rights \
        ...
        \ Fullest Legal Extent\ The <Company> shall indemnify <Indemnitee> to the fullest legal extent even if that indemnification is not set out explicitly in this <Agreement>, the <Company> certificate of incorporation, the <Company>'s bylaws, or statute.

        \ Changes to Legally Permitted Indemnification \ If the extent to which the <Company> can legally indemnify <Indemnitee> expands after the <Effective Date>, the <Company> shall indemnify <Indemnitee> to that further legal extent. Conversely, if the extent to which <Company> can legally indemnify <Indemnitee> contracts after the <Effective Date>, those changes will not reduce <Company>'s obligations to indemnify <Indemnitee> under this <Agreement>.
        ...
        \ Information Sharing \ In any situation when all the following are true
            \\ A third party (""Investigator"") conducts an investigation that implicates <Indemnitee>.
            \\ The <Company> shares information with the <Investigator>.
            \\ <Indemnitee> is entitled to indemnification under {Indemnification} when the <Company> shares information with the <Investigator>.
        then the <Company> shall share all information shared with the <Investigator> with <Indemnitee> as well.

        \ Third-Party Indemnification \

        The <Company> hereby acknowledges that <Indemnitee> has or may from time to time obtain certain rights to indemnification, advancement of expenses and/or insurance provided by one or more third parties (each a ""Third-Party Indemnitor"" and collectively, the ""Third-Party Indemnitors"").
        The <Company> hereby agrees that it is the indemnitor of first resort (i.e., its obligations to <Indemnitee> are primary and any obligation of the <Third-Party Indemnitors> to advance expenses or to provide indemnification for the same expenses or liabilities incurred by <Indemnitee> are secondary),
        and that the <Company> will not assert that the <Indemnitee> must seek expense advancement or reimbursement, or indemnification, from any <Third-Party Indemnitor> before the <Company> must perform its expense advancement and reimbursement, and indemnification obligations, under this <Agreement>.

        No advancement or payment by the <Third-Party Indemnitors> on behalf of <Indemnitee> with respect to any claim for which <Indemnitee> has sought indemnification from the <Company> shall affect the <Company>'s agreement to be indemnitor of first resort.

        The <Third-Party Indemnitors> shall be subrogated to the extent of such advancement or payment to all of the rights of recovery which <Indemnitee> would have had against the <Company> if the <Third-Party Indemnitors> had not advanced or paid any amount to or on behalf of <Indemnitee>.
    ...
    \ Defined Terms and Phrases \ For purposes of this <Agreement>, the following terms shall have the following meanings:
        ...
        # TODO: Revisit extension to subsidiaries, affiliates, etc.
        \\ ""Key Person"" means a director, officer, or key employee of the <Company>.
        ...
        \\ ""Other Indemnification Rights"" means <Indemnitee> rights to indemnification other than under this <Agreement>. <Other Indemnification Rights> includes rights <Indemnitee> has for actions they take in their capacity as a <Key Person> and in other capacities while serving as a <Key Person>. <Other Indemnification Rights> may arise under the <Company>'s certificate of incorporation, the <Company>'s bylaws, another agreement, by vote of stockholders or the <Board>, the Delaware General Corporation Law, and otherwise.
