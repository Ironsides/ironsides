This Indemnification Agreement (this ""Agreement"") between [Company Name], a Delaware corporation (the ""Company""), and [Indemnitee Name] (""Indemnitee"") is dated as of [Effective Date] (the ""Effective Date""). The parties agree as follows:
    ...
    \ Defense of Claim and Selection of Counsel \ In the event the <Company> shall be obligated under {Advancement of Expenses} to advance <Expenses> with respect to any <Legal Dispute>, the <Company>, if appropriate, shall be entitled to assume the defense of such <Legal Dispute>, with counsel reasonably acceptable to <Indemnitee>, upon the delivery to <Indemnitee> of written notice of its election so to do. After delivery of such notice, approval of such counsel by <Indemnitee> and the retention of such counsel by the <Company>, the <Company> will not be liable to <Indemnitee> under this <Agreement> for any fees of counsel subsequently incurred by <Indemnitee> with respect to the same <Legal Dispute>, provided that
