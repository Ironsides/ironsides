...
\\
    ...
    Sale of Stock \\  Subject to the terms and conditions of this <Agreement>, simultaneously with the execution and delivery of this <Agreement> by the parties or on such other date as the <Company> and <Purchaser> shall agree (the ""Purchase Date""), the <Company> will issue and sell to <Purchaser>, and <Purchaser> agrees to purchase from the <Company>, [Number of Shares] shares of the <Company>'s Common Stock (the ""Shares"") at a purchase price of [Purchase Price] per share for a total purchase price of [Total Purchase Price] (the ""Aggregate Purchase Price""). On the <Purchase Date>, <Purchaser> will deliver the <Aggregate Purchase Price> to the <Company> and the <Company> will enter the <Shares> in <Purchaser>'s name as of such date in the <Company>'s stock ledger and list of stockholders (as described by section 220(b)(1) of the Delaware General Corporation Law), or, if applicable, with a duly authorized transfer agent of the <Company>. The <Company> will deliver to <Purchaser>, on request, a notice of issuance with respect to the <Shares> as soon as practical following such date. As used elsewhere in this <Agreement>, the term <Shares> refers to all <Shares> purchased under this <Agreement> and all securities received in connection with the <Shares> pursuant to stock dividends or splits, all securities received in replacement of the <Shares> in a recapitalization, merger, reorganization, exchange or the like, and all new, substituted or additional securities or other property to which <Purchaser> is entitled by reason of <Purchaser>'s ownership of the <Shares>.

    Consideration for Shares \\ As consideration for the <Shares>, <Purchaser> will deliver the <Aggregate Purchase Price> by an assignment of assets as described in the Assignment of IP and Other Assets in the form attached to this <Agreement> as {Form of Assignment of IP And Other Assets}.
    ...
    Lock-up Agreement \\ If so requested by the <Company> or the underwriters in connection with the initial public offering of the <Company>'s securities registered under the <Securities Act>, <Purchaser> shall not sell, make any short sale of, loan, grant any option for the purchase of, or otherwise dispose of any securities of the <Company> however or whenever acquired (except for those being registered) without the prior written consent of the <Company> or such underwriters, as the case may be, for 180 days from the effective date of the registration statement, plus such additional period, to the extent required by FINRA rules, up to a maximum of 216 days from the effective date of the registration statement, and <Purchaser> shall execute any agreement reflecting that restriction requested by the underwriters at the time of such offering.
