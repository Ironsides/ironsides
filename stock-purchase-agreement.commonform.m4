...
\\
    ...
    Investment and Taxation Representations \\ In connection with the purchase of the <Shares>, <Purchaser> represents to the <Company> the following:
        ...
        Burden of Proof \\ <Purchaser> further understands that if all the requirements of Rule 144 are not satisfied, registration under the <Securities Act>, compliance with Regulation A, or some other registration exemption will be required; and that, despite the fact that Rule 144 is not exclusive, the Staff of the Securities and Exchange Commission has expressed its opinion that those proposing to sell private placement securities other than in a registered offering and otherwise than pursuant to Rule 144 will have a substantial burden of proof in establishing that an exemption from registration is available for such offers or sales, and that such sellers and their respective brokers who participate in such transactions do so at their own risk.
