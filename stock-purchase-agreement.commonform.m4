...
\\
    ...
    Sale of Stock \\  Subject to the terms and conditions of this <Agreement>, simultaneously with the execution and delivery of this <Agreement> by the parties or on such other date as the <Company> and <Purchaser> shall agree (the ""Purchase Date""), the <Company> will issue and sell to <Purchaser>, and <Purchaser> agrees to purchase from the <Company>, [Number of Shares] shares of the <Company>'s Common Stock (the ""Shares"") at a purchase price of [Purchase Price] per share for a total purchase price of [Total Purchase Price] (the ""Aggregate Purchase Price""). On the <Purchase Date>, <Purchaser> will deliver the <Aggregate Purchase Price> to the <Company> and the <Company> will enter the <Shares> in <Purchaser>'s name as of such date in the books and records of the <Company> or, if applicable, a duly authorized transfer agent of the <Company>. The <Company> will deliver to <Purchaser>, on request, a notice of issuance with respect to the <Shares> as soon as practical following such date. As used elsewhere in this <Agreement>, the term <Shares> refers to all <Shares> purchased under this <Agreement> and all securities received in connection with the <Shares> pursuant to stock dividends or splits, all securities received in replacement of the <Shares> in a recapitalization, merger, reorganization, exchange or the like, and all new, substituted or additional securities or other property to which <Purchaser> is entitled by reason of <Purchaser>'s ownership of the <Shares>.

    Consideration for Shares \\ As consideration for the <Shares>, <Purchaser> will deliver the <Aggregate Purchase Price> by an assignment of certain assets as described in the Assignment of IP and Other Assets in the form attached to this <Agreement> as {Form of Assignment of IP And Other Assets}.

    Limits on Transfer \\ <Purchaser> shall not assign, encumber or dispose of any interest in the <Shares> except to the extent allowed by, and in compliance with, this <Agreement> and applicable securities laws.

    Repurchase Option; Vesting \\

        \\ On voluntary or involuntary termination of <Purchaser>'s <Continuous Service Status> (as defined below) for any reason (including death or <Disability> (as defined below)), with or without cause, the <Company> shall on the date of such termination (the ""Termination Date"") have an irrevocable, exclusive option (the ""Repurchase Option"") for a period of [Repurchase Period Months] months from such date to repurchase all or any portion of the Unvested <Shares> (as defined below) held by <Purchaser> as of the <Termination Date> at the original purchase price per Share (adjusted for any stock splits, stock dividends and the like) specified in {Sale of Stock}. As used in this <Agreement>, ""Unvested Shares"" means <Shares> that have not yet been released from the <Repurchase Option>.

        Automatic Exercise \\ Unless the <Company> notifies <Purchaser> within [Repurchase Period Months] months from the <Termination Date> that it does not intend to exercise its <Repurchase Option> with respect to some or all the <Unvested Shares>, the <Repurchase Option> shall be deemed automatically exercised by the <Company> as of the end of such [Repurchase Period Months]-month period following such <Termination Date>, provided that the <Company> may notify <Purchaser> that it is exercising its <Repurchase Option> as of a date before the end of such [Repurchase Period Months]-month period. Unless <Purchaser> is otherwise notified by the <Company> pursuant to the preceding sentence that the <Company> does not intend to exercise its <Repurchase Option> for some or all the <Unvested Shares> to which it applies on termination, execution of this <Agreement> by <Purchaser> constitutes written notice to <Purchaser> of the <Company>'s intent to exercise its <Repurchase Option> with respect to all <Unvested Shares> to which such <Repurchase Option> applies. The <Company>, at its choice, may satisfy its payment obligation to <Purchaser> with respect to exercise of the <Repurchase Option> by either

            Check \\ delivering a check to <Purchaser> in the amount of the purchase price for the <Unvested Shares> being repurchased, or

            Cancellation of Debt \\ if <Purchaser> is indebted to the <Company>, canceling an amount of such debt equal to the purchase price for the <Unvested Shares> being repurchased, or

            \\ by a combination of {Check} and {Cancellation of Debt}

        so that the combined payment and cancellation of debt equals such purchase price. On any deemed automatic exercise of the <Repurchase Option> pursuant to {Automatic Exercise} in which <Purchaser> is indebted to the <Company>, such debt equal to the purchase price of the <Unvested Shares> being repurchased shall be deemed automatically canceled as of the end of the [Repurchase Period Months]-month period following the <Termination Date> unless the <Company> otherwise satisfies its payment obligations. As a result of any repurchase of <Unvested Shares> pursuant to {Automatic Exercise}, the <Company> shall become the legal and beneficial owner of the <Unvested Shares> being repurchased and shall have all rights and interest in those <Unvested Shares> or related to those <Unvested Shares>, and the <Company> shall have the right to transfer to its own name the number of <Unvested Shares> being repurchased by the <Company>, without further action by <Purchaser>.

        Vesting Terms \\ [Percentage of Shares Subject to Vesting] of the <Shares> shall initially be subject to the <Repurchase Option> (the ""Vesting Shares""). [Cliff Shares] of the <Vesting Shares> shall be released from the <Repurchase Option> on [Cliff Date], and an additional [Vesting Increment] of the <Vesting Shares> shall be released from the <Repurchase Option> on the [Vesting Date] day of each month after [Cliff Date] (and if there is no corresponding day, the last day of the month), until all <Vesting Shares> are released from the <Repurchase Option>; provided, however, that such scheduled releases from the <Repurchase Option> shall immediately cease as of the <Termination Date>. Fractional shares shall be rounded to the nearest whole share.

        \\ Notwithstanding {Vesting Terms}, if <Purchaser> is terminated without <Cause> (as defined below) by the <Company> (or a successor, if appropriate) or resigns for <Good Reason> (as defined below) in connection with or following the consummation of a <Change of Control> (as defined below), then the vesting of the <Unvested Shares> shall accelerate such that the <Repurchase Option> in {Repurchase Option; Vesting} shall lapse for [Acceleration Percentage] of the <Unvested Shares>. The lapse of repurchase rights provided for in the previous sentence shall occur immediately before the <Termination Date>. In the case of a sale of all or substantially all the <Company>'s assets other than to an <Excluded Entity>, if the acquirer of the <Company>'s assets does not agree to assume this <Agreement>, or to substitute an equivalent award or right for this <Agreement>, and <Purchaser> transfers his employment to such acquirer in connection with such asset sale transaction, then any acceleration of vesting that would otherwise occur on <Purchaser>'s termination shall occur immediately before, and contingent on, the consummation of such asset sale transaction. As used in this <Agreement>, ""Change of Control"" means

            \\ a sale of all or substantially all the <Company>'s assets other than to an <Excluded Entity> (as defined below),
            ...
            \\ the consummation of a transaction, or series of related transactions, in which any "person" (as such term is used in Sections 13(d) and 14(d) of the <Exchange Act>) becomes the "beneficial owner" (as defined in Rule 13d-3 of the <Exchange Act>), directly or indirectly, of all the <Company>'s then outstanding voting securities. However, a transaction shall not constitute a <Change of Control> if its purpose is to
            ...
            An ""Excluded Entity"" means a corporation, limited liability company or other entity of which the holders of voting capital stock of the <Company> outstanding immediately before such transaction are the direct or indirect holders of voting securities representing at least a majority of the votes entitled to be cast by all of such corporation's, limited liability company's or other entity's voting securities outstanding immediately after such transaction. As used in this <Agreement>, ""Cause"" for the <Company> (or a successor, if appropriate) to terminate <Purchaser>'s employment shall exist under the following conditions
    ...
    Right of First Refusal \\
        ...
        \\ Before any <Shares> held by <Purchaser> or any transferee of <Purchaser> (either being sometimes referred to in this <Agreement> as the ""Holder"") may be sold or otherwise transferred (including transfer by gift or operation of law), the <Company> or its assignee(s) shall have a right of first refusal to purchase the <Shares> on the terms and conditions of this {Right of First Refusal} (the ""Right of First Refusal""), which the <Company> may either

            \\ exercise its <Right of First Refusal> and purchase the <Shares> as forth in {Right of First Refusal} or

            \\ reject to exercise its <Right of First Refusal> and let the transfer of the <Shares> to the <Proposed Transferee> (as defined below).
        ...
        Exercise of Right of First Refusal \\ At any time within 30 days after receipt of the <Notice>, the <Company> and/or its assignee(s) may, by giving written notice to the <Holder>, elect to purchase any or all the <Shares> proposed to be transferred to any one or more of the <Proposed Transferee>s, at the <Transfer Purchase Price>, provided that if the <Transfer Purchase Price> consists of no legal consideration (as, for example, in the case of a transfer by gift), the purchase price will be the fair market value of the <Shares> as determined in good faith by the <Company>'s Board of Directors. If the <Transfer Purchase Price> includes consideration other than cash, the cash value of the non-cash consideration shall be determined by the <Company>'s Board of Directors in good faith.
        ...
        Holder's Right to Transfer \\ If any of the <Shares> proposed in the <Notice> to be transferred to a given <Proposed Transferee> are not purchased by the <Company> and/or its assignee(s) as provided in this {Right of First Refusal}, then the <Holder> may sell or otherwise transfer any unpurchased <Shares> to the <Proposed Transferee> at the <Transfer Purchase Price> or at a higher price, provided that such sale or other transfer is consummated within 120 days after the date of the <Notice> and provided further that any such sale or other transfer is effected in accordance with any applicable securities laws and the <Proposed Transferee> agrees in writing that the provisions of {Limits on Transfer} shall continue to apply to the <Shares> in the hands of such <Proposed Transferee>. The <Company>, in consultation with its legal counsel, may require the <Holder> to provide an opinion of counsel evidencing compliance with applicable securities laws. If the <Shares> described in the <Notice> are not transferred to the <Proposed Transferee> within such period, or if the <Holder> proposes to change the price or other terms to make them more favorable to the <Proposed Transferee>, a new <Notice> shall be given to the <Company>, and the <Company> and/or its assignees shall again be offered the <Right of First Refusal> before any <Shares> held by the <Holder> may be sold or otherwise transferred.

        Exception for Certain Family Transfers \\ Anything to the contrary contained in {Right of First Refusal} notwithstanding, the transfer of any or all the <Shares> during <Purchaser>'s lifetime or on <Purchaser>'s death by will or intestacy to <Purchaser>'s <Immediate Family> or to a trust for the benefit of <Purchaser> or <Purchaser>'s <Immediate Family> shall be exempt from the provisions of {Right of First Refusal}. ""Immediate Family"" as used in this <Agreement> shall mean lineal descendant or antecedent, spouse (or spouse's antecedents), father, mother, brother or sister (or their descendants), stepchild (or their antecedents or descendants), aunt or uncle (or their antecedents or descendants), brother-in-law or sister-in-law (or their antecedents or descendants) and shall include adoptive relationships, or any person sharing <Purchaser>'s household (other than a tenant or an employee). In such case, the transferee or other recipient shall receive and hold the <Shares> so transferred subject to the provisions of {Limits on Transfer}, and there shall be no further transfer of such <Shares> except in accordance with the terms of {Limits on Transfer}.

    Company's Right to Purchase on Involuntary Transfer \\ If, at any time after the date of this <Agreement>, of any transfer by operation of law or other involuntary transfer (including divorce or intestate transfer on death, but excluding transfer on death by will (to any transferee) or a transfer to <Immediate Family> as described by {Exception for Certain Family Transfers}) of all or a portion of the <Shares> by the record holder of those <Shares>, the <Company> shall have the right to purchase any or all the <Shares> transferred at the fair market value of the <Shares> on the date of transfer (as determined by the <Company> in its sole discretion). On such a transfer, the <Holder> shall promptly notify the Secretary of the <Company> of such transfer. The right to purchase such <Shares> shall be provided to the <Company> for a period of 30 days following receipt by the <Company> of written notice from the <Holder>.
    ...
    Restrictions Binding on Transferees \\ All transferees of <Shares> or any interest in the <Shares> will receive and hold such <Shares> or interest subject to the provisions of this <Agreement>, including, insofar as applicable, the <Repurchase Option>. Any sale or transfer of the <Shares> shall be void unless the provisions of this <Agreement> are satisfied.

    Termination of Rights \\ The <Right of First Refusal> granted the <Company> by {Right of First Refusal} and the right to repurchase the <Shares> on involuntary transfer granted the <Company> by {Company's Right to Purchase on Involuntary Transfer} shall terminate on the first sale of Common Stock of the <Company> to the general public pursuant to a registration statement filed with and declared effective by the Securities and Exchange Commission under the Securities Act of 1933, as amended (the ""Securities Act"") (other than a registration statement relating solely to the issuance of Common Stock pursuant to a business combination or an employee incentive or benefit plan) or any transfer or conversion of <Shares> made pursuant to a statutory merger or statutory consolidation of the <Company> with or into another corporation or corporations if the common stock of the surviving corporation or any direct or indirect parent corporation of the other corporation or corporations is registered under the Securities Exchange Act of 1934, as amended (the ""Exchange Act"").

    Lock-up Agreement \\ If so requested by the <Company> or the underwriters in connection with the initial public offering of the <Company>'s securities registered under the Securities Act of 1933, as amended, <Purchaser> shall not sell, make any short sale of, loan, grant any option for the purchase of, or otherwise dispose of any securities of the <Company> however or whenever acquired (except for those being registered) without the prior written consent of the <Company> or such underwriters, as the case may be, for 180 days from the effective date of the registration statement, plus such additional period, to the extent required by FINRA rules, up to a maximum of 216 days from the effective date of the registration statement, and <Purchaser> shall execute any agreement reflecting that restriction requested by the underwriters at the time of such offering.

    Escrow of Unvested Shares \\ For purposes of facilitating the enforcement of the provisions of {Limits on Transfer}, <Purchaser> agrees to deliver a Stock Power in the form attached to this <Agreement> as {Stock Power} executed by <Purchaser> and by <Purchaser>'s spouse (if required for transfer), in blank, and such stock certificate(s), if any, to the Secretary of the <Company>, or the Secretary's designee, to hold such <Shares> (and stock certificate(s), if any) and Stock Power in escrow and to take all such actions and to effectuate all such transfers and/or releases as are required in accordance with the terms of this <Agreement>. <Purchaser> hereby acknowledges that the Secretary of the <Company>, or the Secretary's designee, is so appointed as the escrow holder with the these authorities as a material inducement to make this <Agreement> and that said appointment is coupled with an interest and is accordingly irrevocable. <Purchaser> agrees that said escrow holder shall not be liable to any party to this <Agreement> (or to any other party). The escrow holder may rely on any letter, notice or other document executed by any signature purported to be genuine and may resign at any time. <Purchaser> agrees that if the Secretary of the <Company>, or the Secretary's designee, resigns as escrow holder for any or no reason, the Board of Directors of the <Company> shall have the power to appoint a successor to serve as escrow holder pursuant to the terms of this <Agreement>.
    ...
    Investment and Taxation Representations \\ In connection with the purchase of the <Shares>, <Purchaser> represents to the <Company> the following:
        ...
        \\ <Purchaser> is aware of the <Company>'s business affairs and financial condition and has acquired enough information about the <Company> to reach an informed and knowledgeable decision to acquire the <Shares>. <Purchaser> is purchasing the <Shares> for investment for <Purchaser>'s own account only and not with a view to, or for resale in connection with, any "distribution" of the <Shares> within the meaning of the <Securities Act> or under any applicable provision of state law. <Purchaser> does not have any present intent to transfer the <Shares> to any other person or entity.

        \\ <Purchaser> understands that the <Shares> have not been registered under the <Securities Act> by reason of a specific exemption therefrom, which exemption depends on, among other things, the honest and genuine nature of <Purchaser>'s investment intent as expressed in this <Agreement>.
        ...
        Rule 144 \\ <Purchaser> is familiar with the provisions of Rule 144, promulgated under the <Securities Act>, which, in substance, allows limited public resale of "restricted securities"" acquired, directly or indirectly, from the issuer of the securities (or from an affiliate of such issuer), in a non-public offering subject to the satisfaction of certain conditions. <Purchaser> understands that the <Company> provides no assurances about whether he or she will be able to resell any or all the <Shares> pursuant to Rule 144, which rule requires, among other things, that the <Company> be subject to the reporting requirements of the <Exchange Act>, that resales of securities take place only after the holder of the <Shares> has held the <Shares> for certain specified time periods, and under certain circumstances, that resales of securities be limited in volume and take place only pursuant to brokered transactions. Notwithstanding {Rule 144}, <Purchaser> acknowledges and agrees to the restrictions of {Burden of Proof} below.

        Burden of Proof \\ <Purchaser> further understands that if all the applicable requirements of Rule 144 are not satisfied, registration under the <Securities Act>, compliance with Regulation A, or some other registration exemption will be required; and that, notwithstanding the fact that Rule 144 is not exclusive, the Staff of the Securities and Exchange Commission has expressed its opinion that those proposing to sell private placement securities other than in a registered offering and otherwise than pursuant to Rule 144 will have a substantial burden of proof in establishing that an exemption from registration is available for such offers or sales, and that such sellers and their respective brokers who participate in such transactions do so at their own risk.

        \\ <Purchaser> represents that <Purchaser> is not subject to any of the "Bad Actor" disqualifications described in Rule 506(d)(1)(i) to (viii) under the <Securities Act> (attached as {Rule 506(d)(1)(i) to (viii) under the Securities Act of 1933, as amended}).

        \\ <Purchaser> understands that <Purchaser> may suffer adverse tax consequences as a result of <Purchaser>'s purchase or disposition of the <Shares>. <Purchaser> represents that <Purchaser> has consulted any tax consultants <Purchaser> deems advisable in connection with the purchase or disposition of the <Shares> and that <Purchaser> is not relying on the <Company> for any tax advice.

    Restrictive Legends and Stop-Transfer Orders \\

        Legends \\ Any stock certificate or, in the case of uncertificated securities, any notice of issuance, for the <Shares>, shall bear the following legends (as well as any legends required by applicable state and federal corporate and securities laws):
        ...
        Legend and Notice Removal \\ When all the following events have occurred, the <Shares> then held by <Purchaser> will no longer be subject to the legend specified in {Transfer Restriction Legend} and the <Company> will remove any stop-transfer notices associated with the transfer restrictions imposed by this <Agreement>:
            ...
            \\ the expiration or termination of the lock-up provisions of {Lock-up Agreement} (and of any agreement entered pursuant to {Lock-up Agreement}).
    ...
    Certain Defined Terms \\
        ...
        provided that such leave is for a period of not more than ninety (90) days, unless reemployment on the expiration of such leave is guaranteed by contract or statute, or unless provided otherwise pursuant to a written <Company> policy. Also, <Continuous Service Status> as an <Employee> or <Consultant> shall not be considered interrupted or terminated in the case of a transfer between locations of the <Company> or between the <Company>, its <Parent>s, Subsidiaries or <Affiliate>s, or their respective successors, or a change in status from an <Employee> to a <Consultant> or from a <Consultant> to an <Employee>.

        \\ ""Director"" means a member of the Board of Directors of the <Company>.

        \\ ""Disability"" means "disability" within the meaning of Section 22(e)(3) of the <Code>.

        \\ ""Employee"" means any person employed by the <Company>, or any <Parent>, <Subsidiary> or <Affiliate>, with the status of employment determined pursuant to such factors as are deemed appropriate by the Board of Directors of the <Company> in its sole discretion, subject to any requirements of applicable laws, including the <Code>. The payment by the <Company> of a director's fee shall not be enough to constitute "employment" of such director by the <Company> or any <Parent>, <Subsidiary> or <Affiliate>.
...
Rule 506(d)(1)(i) to (viii) under the Securities Act of 1933, as amended \\ See attached.
