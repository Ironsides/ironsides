...
\\
    ...
    Right of First Refusal \\
        ...
        Exercise of Right of First Refusal \\ At any time within 30 days after receipt of the <Notice>, the <Company> and/or its assignee(s) may, by giving written notice to the <Holder>, elect to purchase any or all the <Shares> proposed to be transferred to any one or more of the <Proposed Transferee>s, at the <Transfer Purchase Price>, provided that if the <Transfer Purchase Price> consists of no legal "consideration" (for example, in the case of a gift), the purchase price will be the fair market value of the <Shares> as determined in good faith by the <Company>'s Board of Directors. If the <Transfer Purchase Price> includes non-cash property, the cash value of the non-cash property shall be determined by the <Company>'s Board of Directors in good faith.
