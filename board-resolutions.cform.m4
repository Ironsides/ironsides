\\ The undersigned directors of [Company Name], a Delaware corporation (the ""Company""), all the member of the <Company>'s board of directors (the ""Board""), take the following actions and adopt the following resolutions by unanimous written consent under section 141(f) of the Delaware General Corporation Law and the bylaws of the <Company>.
    ...
    Election of Officers \\ The following people are elected officers of the <Company>: [List of Officers]. Officers of the <Company> (""Officers"") will serve at the pleasure of the <Board>.

    Chief Executive Authority \\ The Chief Executive Officer is authorized to obligate the <Company> in any respect relating to matters of the business of the <Company>, including by entering agreements in the name of the <Company>, within budgets approved by the <Board>. The Chief Executive Officer may delegate that authority in their discretion.
    ...
    Employer Identification Number \\ The <Officers> are authorized and directed to apply for an employer identification number using IRS Form SS-4, unless the incorporator of the <Company> has already applied.

    Fiscal Year \\ The fiscal year of the <Company> will end on December 31 of each year.
    ...
    Withholding Tax \\ The <Officers> are authorized and directed to consult with the bookkeeper, auditors, and attorneys of the <Company> to become fully informed about, collect, and promptly pay, all withholding tax for which the <Company> is now or becomes liable.
    ...
    Management of Fiscal Affairs \\
        ...
        Standard Resolutions \\ The <Board> approves and adopts as its own resolutions any standard form of corporate banking or financial resolutions necessary to accomplish {Accounts}, so long as they show the people authorized to draw on accounts. The <Officers> are authorized to sign, certify, and deliver copies of those resolutions to the financial institutions as the resolutions of the <Company>.

    Ratification \\ The <Board> approves, adopts, ratifies, and confirms all actions taken before the date of this action by the incorporator, officers, and directors with respect to all matters addressed by these resolutions and the transactions contemplated by these resolutions.

    Omnibus Resolution \\ Each of the <Officers> is authorized and empowered to:
