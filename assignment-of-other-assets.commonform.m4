...
Assignment \\
    ...
    \\ The <Assignor> hereby sells, transfers, assigns and conveys, to the <Company>, and its successors and assigns, the <Assignor>'s entire right, title and interest in and to the <Assigned Assets> and all rights of action, power and benefit belonging to or accruing from the <Assigned Assets> including the right to undertake proceedings to recover past and future damages and claim all other relief in respect of any acts of infringement, whether such acts shall have been committed before or after the date of this assignment, the same to be held and enjoyed by said <Company>, for its own use and benefit and the use and benefit of its successors, legal representatives and assigns, as fully and entirely as the same would have been held and enjoyed by the <Assignor>, had this assignment not been made.
